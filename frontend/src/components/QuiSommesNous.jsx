...
function QuiSommesNous() {
  return (
    <div className="bg-blue-400 shadow-lg rounded-lg p-8">
      <h1 className="text-3xl font-bold mb-4">Qui Sommes Nous</h1>
      <p className="text-lg mb-4">Notre histoire de voyage à deux :</p>
      <p className="text-gray-700 mb-4">
        Nous nous sommes rencontrés lors d'un voyage en Asie. Je visitais le
        Japon, et elle voyageait en Thaïlande. Nous avons tous les deux décidé
        d'aller explorer la ville de Hong Kong, et nous nous sommes croisés dans
        une rue animée.
      </p>
      <p className="text-gray-700 mb-4">
